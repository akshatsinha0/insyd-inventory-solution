...
export default function Sidebar({ activeTab, setActiveTab, user, onAuthClick, onLogout }) {
  ...
  return (
    <aside className="w-full md:w-56 bg-white border-r border-gray-200 flex flex-col">
      <div className="p-4 border-b border-gray-200">
        <h1 className="text-base md:text-lg font-semibold text-gray-900">Task: Insyd Prototype Inventory</h1>
